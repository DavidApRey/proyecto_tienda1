    ...
    const data = [
        ...
        },
        {
            ...
            caract_import: [
                {
                    id: 1,
                    datos: 'Resolución Full HD, imágenes mas nítidas.',
                },
                {
                    id: 2,
                    datos: 'Película antirreflejo, trabaja en cualquier condición de luz.',
                },
                {
                    id: 3,
                    datos: 'Dolby Audio, mayor calidad en sonido.',
                },
                {
                    id: 4,
                    datos: 'TrueBlock privacidad para tu cámara',
                },
                {
                    id: 5,
                    datos: 'Webcam Full HD, videollamadas mas claras'
                }
            ],
        ...
        },
        {
            ...
            caract_import: [
                ...
                {
                    id: 3,
                    datos: 'Carga hasta el 60% en solo 49 minutos',
                },
                {
                    id: 4,
                    datos: 'Bajas emisiones de luz azul certificado por TÜV Rheinland',
            ...
            caract_fisica: [{
                caract_teclado: [
                    ...
                    {
                        id: 2,
                        datos: 'Diseño Ergonómico',
                    },
                    {
                        id: 3,
                        datos: 'Numérico Separado'
                    }
                ],
                peso: '1.63 Kilogramos',
                resolucion_camara_web: 'HD',
