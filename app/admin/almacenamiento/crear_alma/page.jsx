        ...
        fetch(`https://backendtienda1311.000webhostapp.com/almaCRUD.php`, {
            ...
            .then((responseData) => {
                ...
                if (responseData == "200") {
                    Toast.fire({
                        icon: "success",
                        title: "Almacenamiento creado con exito"
                    });
                } else {
                    Toast.fire({
                        icon: "error",
                        title: "Error en la creacion de almacenamiento"
                    });
                }
            })
            .catch((error) => {
        ...
        <div className='flex justify-center bg-white w-[50%]'>
            <div>
                <div className='max-w-sm mx-auto space-y-6'>
                    ...
                    <input type="text" id='tipo_disco' className="p-3 mt-2 mb-4 w-full bg-slate-200 rounded text-black" />
                    ...
                    <Link href="../../../admin/almacenamiento" onClick={async () => await crear_enviar()} className="py-3 px-6 my-2 bg-emerald-500 text-white font-medium rounded hover:bg-indigo-500 cursor-pointer ease-in-out duration-300">Actualizar</Link>
                </div>
            </div>
        </div>
    )
